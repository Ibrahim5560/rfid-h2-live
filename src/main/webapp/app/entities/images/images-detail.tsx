    ...
    <Row>
      <Col md="8">
        <h2 data-cy="imagesDetailsHeading">
          <Translate contentKey="rfidh2LiveApp.images.detail.title">Images</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="guid">
              <Translate contentKey="rfidh2LiveApp.images.guid">Guid</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.guid}</dd>
          <dt>
            <span id="plate">
              <Translate contentKey="rfidh2LiveApp.images.plate">Plate</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.plate}</dd>
          <dt>
            <span id="imageLp">
              <Translate contentKey="rfidh2LiveApp.images.imageLp">Image Lp</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="imageThumb">
              <Translate contentKey="rfidh2LiveApp.images.imageThumb">Image Thumb</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="anpr">
              <Translate contentKey="rfidh2LiveApp.images.anpr">Anpr</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.anpr}</dd>
          <dt>
            <span id="rfid">
              <Translate contentKey="rfidh2LiveApp.images.rfid">Rfid</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.rfid}</dd>
          <dt>
            <span id="dataStatus">
              <Translate contentKey="rfidh2LiveApp.images.dataStatus">Data Status</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.dataStatus}</dd>
          <dt>
            <span id="gantry">
              <Translate contentKey="rfidh2LiveApp.images.gantry">Gantry</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.gantry}</dd>
          <dt>
            <span id="lane">
              <Translate contentKey="rfidh2LiveApp.images.lane">Lane</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.lane}</dd>
          <dt>
            <span id="kph">
              <Translate contentKey="rfidh2LiveApp.images.kph">Kph</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.kph}</dd>
          <dt>
            <span id="ambush">
              <Translate contentKey="rfidh2LiveApp.images.ambush">Ambush</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.ambush}</dd>
          <dt>
            <span id="direction">
              <Translate contentKey="rfidh2LiveApp.images.direction">Direction</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.direction}</dd>
          <dt>
            <span id="vehicle">
              <Translate contentKey="rfidh2LiveApp.images.vehicle">Vehicle</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.vehicle}</dd>
          <dt>
            <span id="issue">
              <Translate contentKey="rfidh2LiveApp.images.issue">Issue</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.issue}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="rfidh2LiveApp.images.status">Status</Translate>
            </span>
          </dt>
